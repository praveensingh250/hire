...
<!-- Mirrored from preview.easetemplate.com/influence/html/influence/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Feb 2024 09:43:53 GMT -->
<head>
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item">
                      ...
                      <div id="submenu-1-2" class="collapse submenu">
                        <ul class="nav flex-column">
                          <li class="nav-item">
                            <a class="nav-link active" href="index-2.html">E Commerce Dashboard</a>
                          </li>
                          <li class="nav-item">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td>
                              <div class="m-r-10"><img src="assets/images/product-pic.jpg" alt="user" class="rounded"
                                  width="45"></div>
                            </td>
                            <td>Product #1 </td>
                            <td>id000001 </td>
                            ...
                            <td><span class="badge-dot badge-primary mr-1"></span>InTransit </td>
                          </tr>
                          <tr>
                            <td>2</td>
                            <td>
              ...
              <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12 mb-4">
                <div class="card shadow-sm h-100">
                  ...
                  <div class="card-footer">
                    <p class="h1 font-weight-bold mb-0"><span class="text-primary d-inline-block">$26,000</span><span
...
<!-- Mirrored from preview.easetemplate.com/influence/html/influence/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Feb 2024 09:44:36 GMT -->
</html>