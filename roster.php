                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered first">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <form method="POST" action="common/whatsapp.php">
                           <td>
                          <select name="statin_name">
                            <?php
                            while ($station_row = mysqli_fetch_assoc($station_result)) {
                              // code...
                           
                             ?>
                            <option value="<?php echo $station_row["statin_name"] ?>"><?php echo $station_row["statin_name"] ?> </option>
                          <?php }; ?>
                          </select>
                        </td>
                        <td>
                          <select name="shift_name">
                            ...
                            while ($shift_row = mysqli_fetch_assoc($shift_result)) {
                             ...
                             ?>
                            <option value="<?php echo $shift_row["shift_id"] ?> "><?php echo $shift_row["shift_name"] ?> </option>
                          <?php }; ?>
                          </select>
                        </td>
                        <td><?php echo $row["emp_unique_name"]; ?>
                          <input type="hidden" name="emp_name" value="<?php echo $row["emp_unique_name"]; ?>">
                        </td>
                        <!-- <td><?php echo $row["emp_name"]; ?>
                          <input type="hidden" name="emp_name" value="<?php echo $row["emp_name"]; ?>">
                        </td> -->
                        <!-- <td><?php echo $row["epm_sl_no"] ?>
                          <input type="hidden" name="epm_sl_no" value="<?php echo $row["epm_sl_no"]; ?>">
                        </td> -->
                        <td><?php echo $row["emp_phone"] ?>
