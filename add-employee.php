...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  if ($id==1) {
    $sucess = "<p style='text-align:center;color:green'>Your Employee Is Added Successfuly</p>";
  }
 else
if ($id==2) {
 $sucess = "<p style='text-align:center;color:red'>This UserName Is Already Taken</p>";
            ...
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card mb-5 shadow-sm">
                  ...
                  <div class="card-body">
                    <form method="POST" action="common/add_employee.php">
                      ...
                      <div class="form-group">
                        <label for="inputText3" class="col-form-label">Unique Name</label>
                        <input id="inputText3" name="unique_name" type="text" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="inputEmail">Email address</label>
                        <input id="inputEmail" type="email" name="email_address" placeholder="name@example.com" class="form-control">
                        <p>We'll never share your email with anyone else.</p>
                      </div>
                      <div class="form-group">
                        <label for="inputText4" class="col-form-label">Phone Number</label>
                        <input id="inputText4" type="number" name="phone_number" class="form-control" placeholder="Numbers">
                      </div>
                     <div class="form-group">
                        <label for="inputText4" class="col-form-label">Employee Id</label>
                        <input id="inputText4" type="number" name="emp_id" class="form-control" placeholder="Numbers">
                      </div>
                      <button type="submit" name="submit" class="btn btn-primary btn-lg btn-block" >Add Employee</button>
                    </form>
                  </div>
                  <?php echo $sucess ?>
                </div>
